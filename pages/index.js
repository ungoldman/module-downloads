...
function store (state, emitter) {
  ...
  emitter.on('fetchStats', username => {
    ...
    window.fetch(`/api/${username}`).then(res => res.json()).then(stats => {
      state.stats = stats
      emitter.emit('render')
    })
  })
...
function view (state, emit) {
  ...
  return html`
    <div class="hero green-and-blue">
      <div class="hero-body">
        <div class="content">
          <h1><a href="/">Module Downloads</a></h1>
          ${
            username == null
        ...
        <div class="chip">
          ...
          made with 💻❤️ by <a href="https://github.com/ungoldman">ungoldman</a> | source: <a href="https://github.com/ungoldman/module-downloads">ungoldman/module-downloads</a>
        </div>
      </div>
    </div>
  `
